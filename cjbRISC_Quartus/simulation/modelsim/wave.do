...
add wave -noupdate /cjbRISC_HMMIOP_v_tb/LEDs_tb
...
add wave -noupdate -radix hexadecimal /cjbRISC_HMMIOP_v_tb/muv/DP/R0out
add wave -noupdate -radix hexadecimal /cjbRISC_HMMIOP_v_tb/muv/DP/R1out
add wave -noupdate -radix hexadecimal /cjbRISC_HMMIOP_v_tb/muv/DP/R2out
add wave -noupdate -radix hexadecimal /cjbRISC_HMMIOP_v_tb/muv/DP/R3out
...
WaveRestoreCursors {{Cursor 1} {5375000 ps} 0} {{Cursor 2} {1875000 ps} 0} {{Cursor 3} {11736507 ps} 0}
...
update
WaveRestoreZoom {11160234 ps} {12833672 ps}
